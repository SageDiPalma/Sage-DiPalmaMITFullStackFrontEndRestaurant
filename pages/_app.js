...
function MyApp(props){
  var {cart, resetCart, addItem,removeItem, user, setUser, auth} = useContext(AppContext)
  ...
  return (
    <AppContext.Provider value={{cart: state.cart, resetCart:resetCart, addItem: addItem, removeItem: removeItem,isAuthenticated:true,user:userInfo.user,setUser:setUser}}>
      <Head>
        <link
          rel="stylesheet"
